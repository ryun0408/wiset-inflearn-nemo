...
# <span class="header-icon">🎯</span> EDA REPORT
...
# <span class="header-icon">📋</span> OVERVIEW
## 데이터 개요 및 하이라이트
...
# <span class="header-icon">📊</span> POLARIZATION
## 보증금 및 월세 양극화 분석
...
# <span class="header-icon">🏗️</span> STRUCTURE
## 업종 및 시장 구조 분석
...
# <span class="header-icon">🔍</span> KEYWORDS
## TF-IDF 키워드 분석
...
# <span class="header-icon">📈</span> CORRELATION
## 면적 대비 월세 상관관계
...
# <span class="header-icon">🏢</span> FLOORS
## 층별 가치 분포 비교
...
# <span class="header-icon">🚉</span> SUBWAY
## 지하철역별 매물 공급 현황
...
# <span class="header-icon">📐</span> EFFICIENCY
## 면적당 가격 효율성 분포
...
# <span class="header-icon">🚀</span> SYSTEM ARCHITECTURE
